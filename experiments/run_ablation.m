function results = run_ablation(varargin)
    ...
    variants = {
        'proposed', 'Model 0 (Proposed) - 完全体';
        'no_levy', 'Model 1 (w/o Targeted Levy) - 去掉精准Levy跃迁';
        'no_subpop', 'Model 2 (w/o Multi-Subpop) - 去掉三子种群';
        'no_penalty', 'Model 3 (w/o Isolation Penalty) - 去掉孤岛惩罚';
        'no_stop', 'Model 4 (w/o Smart Stop) - 取消边际收益停止';
        'no_bayesian', 'Model 5 (w/o Bayesian) - 去掉贝叶斯优化';
        'no_adaptive', 'Model 6 (w/o Adaptive) - 去掉自适应参数'
    };
    ...
    for v_idx = 1:size(variants, 1)
        ...
        for run = 1:n_runs
            ...
            switch variant_name
                ...
                case 'no_penalty'
                    [best_fit, bestUAV, cg_curve, energy_consumption, pareto_archive] = ...
                        model3_no_penalty(N_User, User, N_RRH, RRH, RRH_type, N_UAV, UAV_type, Ub, Lb, params, priorities);
                case 'no_stop'
                    [best_fit, bestUAV, cg_curve, energy_consumption, pareto_archive] = ...
                        model4_no_stop(N_User, User, N_RRH, RRH, RRH_type, N_UAV, UAV_type, Ub, Lb, params, priorities);
                case 'no_bayesian'
                    [best_fit, bestUAV, cg_curve, energy_consumption, pareto_archive] = ...
                        model5_no_bayesian(N_User, User, N_RRH, RRH, RRH_type, N_UAV, UAV_type, Ub, Lb, params, priorities);
                case 'no_adaptive'
                    [best_fit, bestUAV, cg_curve, energy_consumption, pareto_archive] = ...
