function [best_fit, bestUAV, cg_curve, energy_consumption, pareto_archive] = model2_no_subpop(N_User, User, N_RRH, RRH, RRH_type, N_UAV, UAV_type, Ub, Lb, params, priorities)
